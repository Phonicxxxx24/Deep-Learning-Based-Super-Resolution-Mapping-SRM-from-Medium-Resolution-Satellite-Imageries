...
class DualPathSRPipeline:
    """Manages Sen2SR-RRDB inference, SEN2SRLite fusion, and frequency filtering."""
    ...
    def run_inference(
        ...
        **kwargs,
        ...
        logger.info(
            "[%s] Starting Sen2SR-RRDB inference on shape %s (TTA=%s, scale=%dx)...",
            aoi_name,
            tuple(lr_gpu.shape),
            run_tta,
            scale_factor,
